...
Dim L As CHRChart
   ...
   If Not VerifyAccessRight("EMPLOYEE_ORG_DELETE", "ลบข้อมูลแผนกและตำแหน่งพนักงาน") Then
...
'      glbErrorLog.ShowUserError
   ...
   glbErrorLog.LocalErrorMsg = "ต้องการลบข้อมูล " & L.ORGANIZE_NAME & " ใช่หรือไม่ ?"
...
Dim itemcount As Long
   ...
   If Not VerifyAccessRight("EMPLOYEE_ORG_ADD", "เพิ่มข้อมูลแผนกและตำแหน่งพนักงาน") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   ...
   If radDepartment.Value Then
      frmAddEditOrganize.HeaderText = "เพิ่มข้อมูลหน่วยงาน"
      frmAddEditOrganize.OrganizeArea = DEPARTMENT_ARA
   ElseIf radPosition.Value Then
      frmAddEditOrganize.HeaderText = "เพิ่มข้อมูลตำแหน่ง"
...
Dim TableName As String
      ...
      If Not VerifyAccessRight("EMPLOYEE_ORG_QUERY", "ค้นหาข้อมูลแผนกและตำแหน่งพนักงาน") Then
         Call EnableForm(Me, True)
         Exit Sub
      End If
   ...
   Call EnableForm(Me, False)
   If radDepartment.Value Then
      frmAddEditOrganize.HeaderText = "แก้ไขข้อมูลหน่วยงาน"
      frmAddEditOrganize.OrganizeArea = DEPARTMENT_ARA
   ElseIf radPosition.Value Then
      frmAddEditOrganize.HeaderText = "แก้ไขข้อมูลตำแหน่ง"
      frmAddEditOrganize.OrganizeArea = POSITION_ARA
   End If
...
Private Sub InitFormLayout()
   ...
   Call InitOptionEx(radDepartment, "หน่วยงาน")
   radDepartment.Value = True
   Call InitOptionEx(radPosition, "ตำแหน่ง")
