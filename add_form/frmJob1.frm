...
Begin VB.Form frmJob1 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSFrame SSFrame2 
         ...
         _Version        =   131073
         PictureBackgroundStyle=   2
         Begin Xivess.uctlTextBox txtInventoryRefNo 
            Height          =   435
            Left            =   2640
            TabIndex        =   24
            Top             =   240
         ...
         Begin VB.Label lblInventoryRefNoMain 
            ...
            Width           =   2355
         End
         Begin VB.Label lblInventoryRefNo 
            Alignment       =   1  'Right Justify
            Caption         =   "Label1"
            Height          =   435
            Left            =   240
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_Job.PRODUCT_NO = txtPartNo.Text
      ...
      m_Job.INVENTORY_REF_NO = txtInventoryRefNo.Text
      m_Job.INVENTORY_REF_NO_MAIN = txtInventoryRefNoMain.Text
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblInventoryRefNo, MapText("หมายเลขเอกสาร LINK"))
   Call InitNormalLabel(lblInventoryRefNoMain, MapText("หมายเลขเอกสารนำเข้า"))
   ...
   Call InitCheckBox(ChkSearch, "ADVANCE SEARCH")
End Sub
...
Dim Ji As CJobItem
   ...
   Values(3) = DateToStringExtEx3(m_TempJob.JOB_DATETIME)
   Values(4) = m_TempJob.PRODUCT_NO
   Values(5) = m_TempJob.PRODUCT_DESC
   Values(6) = FormatNumber(m_TempJob.PRODUCT_AMOUNT)
