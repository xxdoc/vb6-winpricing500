...
Begin VB.Form frmAddEditTransferItem 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Xivess.uctlTextBox txtTotalPrice 
         ...
         _ExtentY        =   767
      End
      Begin Xivess.uctlTextLookup uctlPartToLookup 
         Height          =   435
         Left            =   2235
         TabIndex        =   9
         Top             =   3480
         ...
         _ExtentY        =   767
      End
      Begin Xivess.uctlTextLookup uctlPartTypeToLookup 
         Height          =   435
         Left            =   2235
         TabIndex        =   8
         Top             =   3000
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditTransferItem.frx":1218
         ButtonStyle     =   3
      End
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         Set TempCollection2 = EnpAddr.ExportItem.LotItemLink
...
'      End If
   ...
   Set EnpAddress.ExportItem.LotItemLink = TempCollection2
...
Dim TotalPrice As Double
   ...
   For Each Lk In TempCollection2
      Sum = Lk.IMPORT_AMOUNT
      txtQuantity.Text = Sum
      If Lk.AVG_PRICE > 0 Then
         TotalPrice = (Lk.IMPORT_AMOUNT * Lk.AVG_PRICE)
         txtPrice.Text = MyDiffEx(TotalPrice, Sum)
...
Dim TempID As Long
   ...
   While Not m_Rs.EOF
      ...
      'เราต้องการให้โอนแบบ 1 ต่อ 1 ดังนั้นจึง Disable ส่วนนั้นออก
      If Round(CompareAmount, 2) <= Round(m_LotItem.LOT_ITEM_AMOUNT - m_LotItem.TX_AMOUNT, 2) Then
         ...
         CompareAmount = 0
         txtPrice.Text = m_LotItem.AVG_PRICE
      End If
