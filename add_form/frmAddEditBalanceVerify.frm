...
Begin VB.Form frmAddEditBalanceVerify 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditBalanceVerify.frx":3884
         ButtonStyle     =   3
      End
...
Dim InventoryBals2 As Collection
   ...
   Call Ivd.SetFieldValue("DOCUMENT_NO", "***A-TK_" & uctlDate.ShowDate & "_" & txtNo.Text)
   Call Ivd.SetFieldValue("DOCUMENT_DATE", uctlDate.ShowDate)
   ...
   Call Ivd.SetFieldValue("DOCUMENT_DESC", "ตั้งยอดจาก " & txtNo.Text)
