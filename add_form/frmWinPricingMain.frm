...
Dim I As Long
   ...
   If glbGuiConfigs.VerifyGuiConfig("HR_VIEW") Then
      I = I + 1
      Set Node = trvMain.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-8", I & "." & MapText("ระบบบริหารฝ่ายบุคคล"), 12, 12)
      Node.Expanded = False
   End If
   ...
   If glbGuiConfigs.VerifyGuiConfig("GL_VIEW") Then
      I = I + 1
      Set Node = trvMain.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-10", I & "." & MapText("ระบบบัญชีแยกประเภท"), 10, 10)
      Node.Expanded = False
   End If
   ...
   If glbGuiConfigs.VerifyGuiConfig("COMMISSION_VIEW") Then
      I = I + 1
      Set Node = trvMain.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-11", I & "." & MapText("ระบบคอมมิตชั่น"), 11, 11)
      Node.Expanded = False
   End If
   ...
   If glbGuiConfigs.VerifyGuiConfig("TAGET_VIEW") Then
      I = I + 1
      Set Node = trvMain.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-13", I & "." & MapText("ระบบการตั้งเป้าการขาย"), 12, 12)
      Node.Expanded = False
   End If
   
   If glbGuiConfigs.VerifyGuiConfig("COST_VIEW") Then
      I = I + 1
      Set Node = trvMain.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 1-14", I & "." & MapText("ระบบจัดการตั้งทุน"), 8, 8)
      Node.Expanded = False
   End If
...
Dim DocumentType As Long
   ...
   ElseIf Key = "MASTER_PRODUCTION" Then
      If Not VerifyAccessRight("MASTER_PRODUCTION") Then
         ...
         Exit Sub
      End If
      frmMasterMain.HeaderText = MapText("ข้อมูลหลักระบบการผลิต")
   ...
   ElseIf Key = "LEDGER_PROGRAM" Then
      ...
      ElseIf MenuSelected = 3 Then
         If Not VerifyAccessRight("LEDGER_PROGRAM_KEY ACCOUNT พนักงานขาย") Then
            Call EnableForm(Me, True)
            Exit Sub
         End If
         frmKeyAccount.HeaderText = "KEY ACCOUNT พนักงานขาย"
         Load frmKeyAccount
   ...
   ElseIf Key = "ADJUST_DEALER_TYPE" Then
      If Not VerifyAccessRight("COMMISSION_ADJUST-DEALER-TYPE") Then
         ...
         Exit Sub
      End If
      frmProcessRebate.HeaderText = "ปรับประเภทตัวแทน"
   ...
   ElseIf Key = "COST_CAPITAL" Then
      If Not VerifyAccessRight("COST_CAPITAL") Then
         ...
         Exit Sub
      End If
      frmProcessCommit.ProcessMode = 1 ' "คำนวณต้นทุนคงเหลือและต้นทุนขาย"
      frmProcessCommit.HeaderText = "คำนวณต้นทุนคงเหลือและต้นทุนขาย"
...
Dim iCount As Long
   ...
   If glbUser.GROUP_NAME = "ADMINISTRATOR" Then
      lMenuChosen = oMenu.Popup("เปลี่ยนรหัสผ่าน", "-", "คอนฟิคเลขที่เอกสาร", "-", "รายละเอียดการขนส่ง", "-", "กำหนดวันที่เอกสาร", "-", "กำหนดชื่อเอกสาร", "-", "ประมวลผลสิ้นปี", "-", "นำเข้าข้อมูลลูกค้า")
   Else
      lMenuChosen = oMenu.Popup("เปลี่ยนรหัสผ่าน", "-", "คอนฟิคเลขที่เอกสาร", "-", "รายละเอียดการขนส่ง", "-", "กำหนดวันที่เอกสาร", "-", "กำหนดชื่อเอกสาร", "-", "ประมวลผลสิ้นปี")
   End If
   
   'lMenuChosen = oMenu.Popup("เปลี่ยนรหัสผ่าน", "-", "ล็อคอินใหม่", "-", "ตั้งยอดยกมา", "-", "คอนฟิคเลขที่เอกสาร", "-", "เคลียร์ข้อมูล(ตั้งยอด)", "-", "Clear Memory", "-", "ปรับยอดจำนวน LOT คงเหลือ", "-", "ปรับยอดสต็อคเป็น 0", "-", "รายละเอียดการขนส่ง")
   ...
   ElseIf lMenuChosen = 5 Then
      If Not VerifyAccessRight("PROGRAM_ข้อมูลรายละเอียดการขนส่ง") Then
         Call EnableForm(Me, True)
         Exit Sub
     End If
      Load frmTranSport
   ...
   ElseIf lMenuChosen = 9 Then
      If Not VerifyAccessRight("PROGRAM_กำหนดชื่อเอกสาร") Then
         Call EnableForm(Me, True)
         Exit Sub
      End If
      frmTitleDocuments.HeaderText = "กำหนดชื่อเอกสาร"
   ...
   ElseIf lMenuChosen = 11 Then
      If Not VerifyAccessRight("PROGRAM_ประมวลผลสิ้นปี") Then
         Call EnableForm(Me, True)
         Exit Sub
      End If
      frmProcessEndYear.HeaderText = "ประมวลผลสิ้นปี"
...
'         Exit Sub
'      End If
      frmProcessEndYear.HeaderText = "นำเข้าข้อมูลลูกค้า"
...
'   ElseIf lMenuChosen = 3 Then
'      If Not VerifyAccessRight("PROGRAM_ล็อคอินใหม่") Then
'         Call EnableForm(Me, True)
'         Exit Sub
'     End If
'      Load frmLogin
...
'   ElseIf lMenuChosen = 9 Then
'      frmProcessCommit.ProcessMode = 2 ' "เคลียร์ข้อมูล(ตั้งยอด)"
'      frmProcessCommit.HeaderText = "เคลียร์ข้อมูล(ตั้งยอด)"
'
'      Load frmProcessCommit
'      frmProcessCommit.Show 1
'
...
'      Call UnLoadAllForm
'   ElseIf lMenuChosen = 13 Then
'      frmAdjustLotItemLink.HeaderText = "ปรับยอดจำนวน LOT คงเหลือ"
...
'      frmAdjustStockCodeToZero.HeaderText = "ปรับยอดจำนวนคงเหลือเป็น 0"
...
Dim TempCol As Collection
   ...
   Set MI = New CMenuItem
   MI.KEY_ID = 3
   MI.KEYWORD = "รายการ KEY ACCOUNT ของพนักงานขาย"
   Call Col.add(MI)
   Set MI = Nothing
