...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      frmAddEditMasterFTItem.HeaderText = MapText("เพิ่ม" & Comissiontype2Text(DocumentType))
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      Set frmAddEditMasterFTItem.TempCollection = m_MasterFromTo.Details
      frmAddEditMasterFTItem.DocumentType = DocumentType
      frmAddEditMasterFTItem.HeaderText = MapText("แก้ไข" & Comissiontype2Text(DocumentType))
...
Dim I As Byte
   ...
   Col.Caption = MapText("กลุ่มคอมมิตชั่น")
   ...
   Col.Width = (ScaleWidth - 600) / 7
   Col.TextAlignment = jgexAlignRight
   Col.Caption = MapText("ยอดค่าคอม")
   
   Set Col = GridEX1.Columns.add '7
   Col.Width = (ScaleWidth - 600) / 7
   Col.TextAlignment = jgexAlignRight
   Col.Caption = MapText("สะสม")
End Sub
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      ElseIf CR.GetFieldValue("AMOUNT_X_FLAG") = "Y" Then
         Values(7) = "จำนวน คูณ " & FormatNumber(CR.GetFieldValue("MASTER_FROMTO_DETAIL_VALUE1"))
      ElseIf CR.GetFieldValue("VALUE_X_FLAG") = "Y" Then
         Values(7) = "ยอดขาย คูณ " & FormatNumber(CR.GetFieldValue("MASTER_FROMTO_DETAIL_VALUE1"))
      End If
